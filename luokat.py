...
if __name__ == "__main__":
    ...
    anneh = Aikuinen('Anne', 'Helin', 150, 50, 43, 0, 70)
    print(anneh.etunimi, 'painoindeksi', anneh.painoindeksi())
    print(anneh2.etunimi, 'rasvaprosentti', anneh.rasvaprosentti())
...
if __name__ == '__main__':
    anneh = Henkilo('Anne', 'Helin', 150, 50, 43, 0)
    print('Henkilo painaa', anneh.paino)

    anneh.painoindeksi()

    anneh = Aikuinen('Anne', 'Helin', 150, 50, 43, 0)
    print(anneh.etunimi, 'painoindeksi'), anneh.painoindeksi())
    print(anneh.etunimi, 'rasvaprrosentti', anneh.rasvaprosentti())
